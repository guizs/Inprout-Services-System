    ...
    <tr>
        ...
        if (lancamentos && lancamentos.length > 0) {
            lancamentos.forEach(lanc => {
                ...
                // --- INÍCIO DA CORREÇÃO ---
                // 1. Quebra a string da LPU (ex: "CODIGO - NOME") em partes.
                const lpuParts = lanc.lpu ? lanc.lpu.split(' - ') : ['N/A'];
                const lpuCode = lpuParts[0];
                // 2. Pega o resto como o nome, caso o nome também tenha hífens.
                const lpuName = lpuParts.length > 1 ? lpuParts.slice(1).join(' - ') : (lanc.objetoContratado || 'N/A');
                // --- FIM DA CORREÇÃO ---
