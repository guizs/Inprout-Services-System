document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderizarTabela(dados, tbodyElement, colunas) {
        ...
        dados.forEach(lancamento => {
            ...
            const mapaDeCelulas = {
                ...
                "PLANO DE VISTORIA": lancamento.planoVistoria || '',
                "DESMOBILIZAÇÃO": lancamento.desmobilizacao || '',
                "PLANO DE DESMOBILIZAÇÃO": lancamento.planoDesmobilizacao || '',
                "INSTALAÇÃO": lancamento.instalacao || '',
                "PLANO DE INSTALAÇÃO": lancamento.planoInstalacao || '',
                "ATIVAÇÃO": lancamento.ativacao || '',
                "PLANO DE ATIVAÇÃO": lancamento.planoAtivacao || '',
                "DOCUMENTAÇÃO": lancamento.documentacao || '',
                "PLANO DE DOCUMENTAÇÃO": lancamento.planoDocumentacao || '',
    ...
    if (modalAdicionarEl) {
        ...
        function preencherCamposOS(osId) {
            ...
            if (osSelecionada) {
                // Pega o primeiro item da lista de detalhes para os campos específicos
                const primeiroDetalhe = (osSelecionada.detalhes && osSelecionada.detalhes.length > 0) ? osSelecionada.detalhes[0] : {};

                document.getElementById('site').value = primeiroDetalhe.site || '';
                ...
                document.getElementById('contrato').value = primeiroDetalhe.contrato || '';
                document.getElementById('gestorTim').value = osSelecionada.gestorTim || '';
                document.getElementById('regional').value = primeiroDetalhe.regional || '';
            }
        }
