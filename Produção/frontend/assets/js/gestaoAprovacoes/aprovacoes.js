...
`;
    ...
    function renderizarTabelaHistorico(dados) {
        ...
        dados.forEach(lancamento => {
            ...
            const mapaDeCelulas = {
                "COMENTÁRIOS": `<button class="btn btn-sm btn-outline-secondary" onclick="verComentarios(${lancamento.id})" ${!lancamento.comentarios || lancamento.comentarios.length === 0 ? 'disabled' : ''}><i class="bi bi-eye"></i></button>`,
