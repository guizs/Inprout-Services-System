...
async function carregarLpusNoSelect(selectId, filtroAtivo, textoPlaceholder) {
    ...
    const url = `https://www.inproutservices.com.br/contrato`;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (modalCriarLPU) {
        ...
        formCriarLPU.addEventListener('submit', async function (event) {
            ...
            try {
                const response = await fetchComAuth('https://www.inproutservices.com.br/lpu', {
                    method: 'POST',
    ...
    if (modalAlterarLPU) {
        ...
        document.getElementById('selectLPUAlterar').addEventListener('change', async function (event) {
            ...
            try {
                ...
                const lpuResponse = await fetchComAuth(`https://www.inproutservices.com.br/lpu/${lpuId}`);
                ...
                const contratosResponse = await fetchComAuth('https://www.inproutservices.com.br/contrato');
        ...
        formAlterarLPU.addEventListener('submit', async function (event) {
            ...
            try {
                ...
                const response = await fetchComAuth(`https://www.inproutservices.com.br/lpu/${lpuId}`, {
                    method: 'PATCH',
                    headers: { 'Content-Type': 'application/json' },
    ...
    if (modalAtivarLPU) {
        ...
        btnConfirmarReativacao.addEventListener('click', async function (event) {
            ...
            try {
                const url = `https://www.inproutservices.com.br/lpu/${lpuId}`;
                const response = await fetchComAuth(url, {
                    method: 'PATCH',
                    headers: {
