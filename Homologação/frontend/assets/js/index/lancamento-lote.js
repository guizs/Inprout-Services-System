document.addEventListener('DOMContentLoaded', () => {
    ...
    // INÍCIO DA CORREÇÃO: Variáveis que estavam faltando
    const chkAtividadeComplementar = document.getElementById('chkAtividadeComplementar');
    const quantidadeComplementarContainer = document.getElementById('quantidadeComplementarContainer');

    if (chkAtividadeComplementar) {
